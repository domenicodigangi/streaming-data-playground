...
kubectl apply -f deploy/grafana/grafana-deployment.yml  -n $NAMESPACE
...
nohup kubectl port-forward -n $NAMESPACE deployment/$DEPLOYMENT 3000:3000 > port_forward_grafana.log|| true &
